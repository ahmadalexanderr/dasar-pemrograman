...
# Aplikasi
D = Date(16, 9, 1997)  # 16 September 1997
A = Date(9, 9, 1996)
print(Day(D))
print(Month(D))
print(Year(D))
# print(MakeDate(9, 9, 96))
D1 = MakeDate(1, 1, 1980)
print(Nextday(D1))
D2 = MakeDate(31, 1, 1980)
print(Nextday(D2))
D3 = MakeDate(30, 4, 1980)
print(Nextday(D3))
D4 = MakeDate(31, 12, 1980)
print(Nextday(D4))
D5 = MakeDate(28, 2, 1980)
print(Nextday(D5))
D6 = MakeDate(28, 2, 1982)
print(Nextday(D6))
D7 = MakeDate(1, 1, 1980)
print(Yesterday(D7))
D8 = MakeDate(31, 1, 1980)
print(Yesterday(D8))
D9 = MakeDate(1, 5, 1980)
print(Yesterday(D9))
D10 = MakeDate(31, 12, 1980)
print(Yesterday(D10))
D11 = MakeDate(29, 2, 1980)
print(Yesterday(D11))
D12 = MakeDate(1, 3, 1980)
print(Yesterday(D12))
print(NextNDay(D12, 30))
# IsEqD
D13 = MakeDate(1, 1, 1990)
D14 = MakeDate(1, 1, 1990)
print(IsEqD(D13, D14))
# IsBefore
D15 = MakeDate(1, 1, 1980)
D16 = MakeDate(2, 1, 1980)
print(IsBefore(D15, D16))
D17 = MakeDate(1, 11, 1983)
D18 = MakeDate(1, 2, 1980)
print(IsAfter(D17, D18))
